...
describe 'GET #destroy' do
  ...
  describe "POST #create" do
    ...
    context "with invalid attributes" do
      it "fail to create new review" do
	u = FactoryGirl.build :invalid_review
	post :create, rental_id: u.rental_id, review: u.attributes
  ...
  describe "PUT #update" do
    ...
    it 'should update review' do
      ...
      put :update, id: u.id, review: valid
      u.reload
      expect(u.overall).to eql valid[:overall]
    end
    it 'should fail updating review' do
      u = FactoryGirl.create :review
      put :update, :id => u.id, review: invalid
      u.reload
